...
wget -O /usr/local/bin/ws "https://raw.githubusercontent.com/GeKaStore/WZSC/main/sshws/ws"
chmod +x /usr/local/bin/ws

# Installing Service
cat > /etc/systemd/system/ws.service << END
[Unit]
Description=Proxy Mod By WUZZSTORE
...
wget -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/GeKaStore/WZSC/main/os/sshws/ws"
